...
<!-- ── HEADER ── -->
<div class="top-bar">
    <img class="logo" src="{{ asset('img/logo-seedling-fondo-verde.svg') }}" alt="Agrogranja"
    ...
    <div class="form-side">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <input class="field-input" type="email" id="email" name="email"
                   placeholder="juan@finca.com" value="{{ old('email') }}" required>
            ...
            <input class="field-input" type="text" id="telefono" name="telefono"
                   placeholder="300 123 4567" value="{{ old('telefono') }}">
            ...
            <input class="field-input" type="text" id="nombre_finca" name="nombre_finca"
                   placeholder="Finca El Paraíso" value="{{ old('nombre_finca') }}">
            ...
            <div class="field-row">
                ...
                <div>
                    ...
                    <input class="field-input" type="text" id="municipio" name="municipio"
                           placeholder="Tu municipio" value="{{ old('municipio') }}">
                </div>
            </div>
