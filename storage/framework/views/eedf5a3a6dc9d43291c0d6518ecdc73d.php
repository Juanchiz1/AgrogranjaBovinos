...
<link rel="stylesheet" href="<?php echo e(asset('css/ingresos.css')); ?>">
<?php $__env->stopPush(); ?>
...
<div class="tab-panel-i active" id="tab-i-ingresos">
  ...
  <optgroup label="💰 Ventas">
    ...
    <option value="cosecha_propia">🌾 Cosecha / Producción</option>
    <option value="animal">🐄 Venta de animal</option>
  </optgroup>
  <optgroup label="🥛 Subproductos">
    <option value="leche">🥛 Venta de leche</option>
    <option value="huevos">🥚 Venta de huevos</option>
    <option value="subproducto">📦 Otro subproducto</option>
  </optgroup>
  <optgroup label="🔧 Servicios y otros">
    <option value="servicio">🔧 Servicio prestado</option>
    <option value="alquiler">🏡 Alquiler de tierra/equipo</option>
    <option value="subsidio">🏛️ Subsidio / Ayuda gobierno</option>
    <option value="prestamo">🏦 Préstamo / Crédito</option>
    <option value="devolucion">↩️ Devolución / Reembolso</option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Juan Diego\Documents\Universidad Documentos clases\Desarrollo Web 2\AgroGranja Bovinos\AgrogranjaBovinos\resources\views/pages/ingresos.blade.php ENDPATH**/ ?>