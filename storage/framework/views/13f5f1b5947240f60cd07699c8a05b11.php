      ...
      <form method="POST" action="<?php echo e(route('animales.update',$a->id)); ?>" enctype="multipart/form-data"><?php echo csrf_field(); ?>
        ...
        <div class="form-group">
          ...
          <input type="number" name="peso_meta_kg" step="1" min="0"
                 class="form-control"
                 value="<?php echo e($a->peso_meta_kg ?? ''); ?>"
                 placeholder="Ej: 450">
...
<div class="modal-overlay" id="modalNuevoAnimal" style="display:none;">
  <div class="modal-sheet"><div class="modal-handle"></div><h3 class="modal-title">🐾 Nuevo animal</h3>
    <form method="POST" action="<?php echo e(route('animales.store')); ?>" enctype="multipart/form-data"><?php echo csrf_field(); ?>
      ...
      <div id="camposBovinos" style="display:none;">
  <div class="grid-2">
    <div class="form-group">
      <label>Raza</label>
      <input type="text" name="raza" class="form-control"
             placeholder="Brahman, Holstein, Normando...">
    </div>
    <div class="form-group">
      <label>Categoría</label>
      <select name="categoria_bovina" class="form-control">
  ...
  <div class="form-group">
    <label>Meta de peso al sacrificio (kg)</label>
    <input type="number" name="peso_meta_kg" step="1" min="0"
           class="form-control" placeholder="Ej: 450">
  </div>
</div>
...
function updateVentaMode() {
  ...
  document.getElementById('camposBovinos').style.display   = esBovino.includes(esp) ? 'block' : 'none';
}
</script>
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Juan Diego\Documents\Universidad Documentos clases\Desarrollo Web 2\AgroGranja Bovinos\AgrogranjaBovinos\resources\views/pages/animales.blade.php ENDPATH**/ ?>