...
<div id="wrapCompradorProd">
  ...
  <?php if(isset($compradores) && $compradores->count()): ?>
  <div class="form-group">
    ...
    <select name="persona_id" class="form-control"
      ...
      <?php $__currentLoopData = $compradores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($cl->id); ?>"><?php echo e($cl->nombre); ?></option>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </select>
  </div>
  <?php endif; ?>
...
<div id="wrapInvProd" style="display:none;">
  ...
  <div class="form-group">
    ...
    <select name="inventario_id" class="form-control">
      ...
      <?php $__currentLoopData = $inventarioItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($inv->id); ?>"><?php echo e($inv->nombre); ?> (<?php echo e($inv->cantidad_actual); ?> <?php echo e($inv->unidad); ?>)</option>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </select>
  </div>
  <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Juan Diego\Documents\Universidad Documentos clases\Desarrollo Web 2\AgroGranja Bovinos\AgrogranjaBovinos\resources\views/pages/animal-detalle.blade.php ENDPATH**/ ?>