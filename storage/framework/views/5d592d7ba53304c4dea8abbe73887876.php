...
<div class="header">
  ...
  <div class="header-title">Reporte General <?php echo e($anio); ?></div>
...
<div class="balance-box <?php echo e($balance >= 0 ? 'positivo' : 'negativo'); ?>" style="margin-top:20px;">
  <div class="balance-main">
    <div class="valor <?php echo e($balance >= 0 ? 'pos' : 'neg'); ?>">$<?php echo e(number_format(abs($balance),0,',','.')); ?></div>
    <div class="etiqueta">Balance <?php echo e($anio); ?> — <?php echo e($balance >= 0 ? 'Ganancia neta' : 'Pérdida neta'); ?></div>
  </div>
  <div class="balance-pill <?php echo e($balance >= 0 ? '' : 'neg'); ?>">
    <?php echo e($balance >= 0 ? 'Rentable' : 'En pérdida'); ?>
...
<div class="kpis">
  <div class="kpi verde">
    <div class="k-val">$<?php echo e(number_format($totalIngresos/1000,1)); ?>k</div>
    <div class="k-lbl">Ingresos totales</div>
  </div>
  <div class="kpi marron">
    <div class="k-val">$<?php echo e(number_format($totalGastos/1000,1)); ?>k</div>
    <div class="k-lbl">Gastos totales</div>
  </div>
  <div class="kpi azul">
    <div class="k-val">$<?php echo e(number_format($totalCosechas/1000,1)); ?>k</div>
    <div class="k-lbl">Val. cosechas</div>
  </div>
  <div class="kpi gris">
    <div class="k-val"><?php echo e($cultivos->count()); ?></div>
...
<div class="section">
  ...
  <table class="month-table">
    <thead>
      <tr>
        <th>Concepto</th>
        <?php $__currentLoopData = ['Ene','Feb','Mar','Abr','May','Jun','Jul','Ago','Sep','Oct','Nov','Dic']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <th><?php echo e($m); ?></th>
    ...
    <tbody>
      <tr>
        <td>Ingresos</td>
        <?php for($m=1;$m<=12;$m++): ?>
        <td class="pos">$<?php echo e(number_format(($ingresosMes[$m]??0)/1000,0)); ?>k</td>
        <?php endfor; ?>
      </tr>
      <tr>
        <td>Gastos</td>
        <?php for($m=1;$m<=12;$m++): ?>
        <td class="neg">$<?php echo e(number_format(($gastosMes[$m]??0)/1000,0)); ?>k</td>
        <?php endfor; ?>
      </tr>
      <tr class="bal-row">
        <td>Balance</td>
        <?php for($m=1;$m<=12;$m++): ?>
        <?php $b2 = ($ingresosMes[$m]??0) - ($gastosMes[$m]??0); ?>
        <td class="<?php echo e($b2 >= 0 ? 'pos' : 'neg'); ?>">$<?php echo e(number_format($b2/1000,0)); ?>k</td>
        <?php endfor; ?>
      </tr>
    </tbody>
  </table>
...
</html><?php /**PATH C:\Users\Juan Diego\Documents\Universidad Documentos clases\Desarrollo Web 2\AgroGranja Bovinos\AgrogranjaBovinos\resources\views/exports/reporte-general-pdf.blade.php ENDPATH**/ ?>