...
<div class="header">
  ...
  <div class="header-meta">
    ...
    <?php endif; ?>
    <div><span>Total registros</span><strong><?php echo e($cultivos->count()); ?> cultivos</strong></div>
  </div>
</div>

<div class="kpis">
  <div class="kpi verde">
    <div class="k-val"><?php echo e($stats['activos']); ?></div>
    <div class="k-lbl">Activos</div>
  </div>
  <div class="kpi naranja">
    <div class="k-val"><?php echo e($stats['cosechados']); ?></div>
    <div class="k-lbl">Cosechados</div>
  </div>
  <div class="kpi marron">
    <div class="k-val"><?php echo e($stats['vendidos']); ?></div>
    <div class="k-lbl">Vendidos</div>
  </div>
  <div class="kpi azul">
    <div class="k-val"><?php echo e(number_format($stats['total_area'],1)); ?></div>
...
<div class="section">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td style="color:#94a3b8;font-family:sans-serif;"><?php echo e($i+1); ?></td>
        <td>
          <div class="nombre"><?php echo e($c->nombre); ?></div>
        </td>
        <td style="font-family:sans-serif;"><?php echo e($c->tipo); ?></td>
        <td style="font-family:sans-serif;white-space:nowrap;">
          <?php echo e($c->fecha_siembra ? \Carbon\Carbon::parse($c->fecha_siembra)->format('d/m/Y') : '—'); ?>

        </td>
        <td style="font-family:sans-serif;white-space:nowrap;">
          <?php echo e($c->area ? number_format($c->area,2).' '.($c->unidad ?? 'ha') : '—'); ?>

        </td>
        <td><span class="badge badge-<?php echo e($c->estado); ?>"><?php echo e(ucfirst($c->estado)); ?></span></td>
        <td class="nota-text"><?php echo e($c->notas ? \Illuminate\Support\Str::limit($c->notas, 45) : '—'); ?></td>
      </tr>
...
<div class="footer">
  <div><strong>Agrogranja</strong> — Sistema de Gestión para Fincas &nbsp;|&nbsp; Total: <?php echo e($cultivos->count()); ?> cultivos registrados</div>
  <div>agrogranja.app</div>
</div>

</body>
</html><?php /**PATH C:\Users\Juan Diego\Documents\Universidad Documentos clases\Desarrollo Web 2\AgroGranja Bovinos\AgrogranjaBovinos\resources\views/exports/cultivos-pdf.blade.php ENDPATH**/ ?>